        ...
        do
          ...
          do
            ...
            do
              ...
              python python/knn/hybrid_knn_merge.py -fs ${nfold_root}/$t/fold$fold/${data_root}/${k}/${lt}/${method}/vote_score.tsv \
                                                    -fk ${nfold_root}/$t/fold$fold/${data_root}/10nn_res.tsv \
                                                    -ds ${nfold_root}/$t/fold$fold/${data_root}/${q}/${lt}/${method}/vote_score.tsv \
                                                    -dk ${nfold_root}/$t/fold$fold/${data_root}/test_${q}_res.tsv \
                                                    -k ${k} \
                                                    -m ${based} \
