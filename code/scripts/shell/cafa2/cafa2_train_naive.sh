...
do
  ...
  do
    ...
    './thesis/data/cafa2_train/nfold/$t/fold$fold/train_leaf.txt',\
    './thesis/data/cafa2_train/nfold/$t/fold$fold/test_ID.txt',\
    './thesis/data/cafa2_train/nfold/$t/fold$fold/naive_leaf');quit;"
    matlab -nodisplay -r "addpath('./cafa2_eval/myscript');\
    naive_pred('./cafa2_eval/matlab','$t','./data/go_20130615-termdb.obo',\
    './thesis/data/cafa2_train/nfold/$t/fold$fold/test_pro.txt',\
    './thesis/data/cafa2_train/nfold/$t/fold$fold/train_pro.txt',\
    './thesis/data/cafa2_train/nfold/$t/fold$fold/test_ID.txt',\
    './thesis/data/cafa2_train/nfold/$t/fold$fold/naive_pro');quit;"
  done
done
