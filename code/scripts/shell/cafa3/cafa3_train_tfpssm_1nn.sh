...
do
  ...
  do
    python python/pca/pca_folder.py -i thesis/data/cafa3_train/tfpssm/ \
    ...
    python python/pca/pca_folder.py -i thesis/data/cafa3_train/tfpssm/ \
                                ...
                                -o thesis/data/cafa3_train/nfold/$t/fold$fold/train_tfpssm_pca.csv
    python python/pca/pca_folder.py -i thesis/data/cafa3_train/tfpssm/ \
                                -l thesis/data/cafa3_train/nfold/$t/fold$fold/test_ID.txt -list \
                                -m thesis/data/cafa3_train/nfold/$t/fold$fold/nr_pca_model.pkl \
                                -o thesis/data/cafa3_train/nfold/$t/fold$fold/test_tfpssm_pca.csv
    nextflow oneNN.nf --train_vec thesis/data/cafa3_train/nfold/$t/fold$fold/train_tfpssm_pca.csv \
                      --train_label thesis/data/cafa3_train/nfold/$t/fold$fold/train_leaf.txt \
                      --test_vec thesis/data/cafa3_train/nfold/$t/fold$fold/test_tfpssm_pca.csv \
                      --cat $t \
                      ...
                      --output thesis/data/cafa3_train/nfold/$t/fold$fold/tfpssm_1nn/
  done
done
