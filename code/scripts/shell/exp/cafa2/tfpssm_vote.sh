...
do
  ...
  do
    mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn
    for pca_r in r nr #for pca
    do
      mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}
      for p in 25 50 75
      do
        mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}
        output_path=thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}
        pca_path=thesis/data/cafa2_train/nfold/$t/fold$fold/exp/0.95/w/${pca_r}
        # Non-redundant for knn
        mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}/nr
        ...
        for lt in pro leaf
        do
          mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}/nr/${lt}
          cur_path=thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}/nr/${lt}
        ...
        # Redundant for knn
        mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}/r
        ...
        for lt in pro leaf
        do
          mkdir thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}/r/${lt}
          cur_path=thesis/data/cafa2_train/nfold/$t/fold$fold/exp_knn/${pca_r}/${p}/r/${lt}
